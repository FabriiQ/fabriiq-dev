...
export default function Sidebar() {
  ...
  useEffect(() => {
    if (selectedWorkspace && sidebarRef.current) {
      const workspaceElement = document.getElementById(selectedWorkspace);
      if (workspaceElement) {
          ...
          <div className="flex-grow flex flex-col min-w-[235px]">
            <div className="relative h-[calc(100%-60px)] flex flex-col w-full justify-between pt-[10px] overflow-y-scroll no-scroll">
              <div className="flex flex-col gap-y-2 pb-[60px] overflow-y-scroll no-scroll">
                ...
                <ActiveWorkspaces searchQuery={searchQuery} setSelectedWorkspace={handleWorkspaceSelect} />
              </div>
            </div>
            ...
            <div className="h-full flex flex-col w-full justify-between pt-4 ">
              <div className="h-auto md:sidebar-items">
                <div className=" flex flex-col gap-y-4 overflow-y-scroll no-scroll pb-[60px]">
                  ...
                  <ActiveWorkspaces searchQuery={searchQuery} setSelectedWorkspace={setSelectedWorkspace} />
                </div>
              </div>
